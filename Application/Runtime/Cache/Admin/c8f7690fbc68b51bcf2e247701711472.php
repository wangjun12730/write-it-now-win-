            ...
            <table class="table table-striped table-hover table-condensed" style="margin-top: 30px">
                ...
                <?php if($res1 != 0): ?><!-- 显示搜索用户id得到的数据-->
                    <tr>
                        ...
                        <td style="padding-top: 20px "><div   data-toggle="popover" data-trigger="hover" data-placement="top" data-content="<?php echo ($res1["info"]); ?>"  title="<?php echo ($res1["info"]); ?>" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;width:145px;">
                            <?php echo ($res1["info"]); ?>
                        </div></td>
                ...
                <?php if(is_array($res2)): foreach($res2 as $key=>$v): ?><tr>
                        ...
                        <td style="padding-top: 20px "><div   data-toggle="popover" data-trigger="hover" data-placement="top" data-content="<?php echo ($v["info"]); ?>" title="<?php echo ($v["info"]); ?>" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;width:145px;">
                            <?php echo ($v["info"]); ?>
                        </div></td>
