...
<div class="story">
    ...
    <hr />
    <div class="content">
        <button class="btn btn-warning">章节</button>
        <div class="container">
            <div class="row" style="margin-top: 20px;margin-bottom: 50px">
                <?php if($empty==1): ?><h1>您现在还没有章节</h1>
                    <?php else: ?>
                    <?php if(is_array($res2)): foreach($res2 as $key=>$v): ?><div class="col-sm-4 col-xs-6 text-center section" style="margin-bottom: 30px">
                            <a class="btn btn-danger" onclick="location='/write-it-now-win-/Admin/Story/storySectionDetail/section_id/<?php echo ($v["id"]); ?>'"><?php echo ($v["section"]); ?> <?php echo ($v["title"]); ?></a>
