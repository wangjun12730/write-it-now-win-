...
<div class="showBanUser">
    <div  style="margin-bottom: 30px;margin-top: 20px" >
        ...
        <a class="btn btn-warning">被封禁用户</a>
    </div>

    <?php if($empty==1): ?><h3>没有用户被封禁</h3>
        <?php else: ?>
        <table class="table table-striped table-hover table-condensed">
            ...
            <?php if(is_array($result)): foreach($result as $key=>$v): ?><tr>
                    ...
                    <td style="padding-top: 20px "><div   data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="<?php echo ($v["per_signature"]); ?>" title="个性签名" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;width:145px;">
                        <?php echo ($v["per_signature"]); ?>
                    </div></td>
                    <td style="padding-top: 20px "><?php echo ($v["is_ban"]); ?></td>
                    <td style="padding-top: 15px "><a  class="btn btn-primary ban" href="/write-it-now-win-/Admin/User/deblocking/user_id/<?php echo ($v["id"]); ?>">解封</a></td>
