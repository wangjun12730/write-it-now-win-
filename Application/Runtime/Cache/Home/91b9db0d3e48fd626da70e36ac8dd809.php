...
<div class="container" style="background-color: white;margin-top: 15px;padding-top: 15px;margin-bottom: 30px">
    <div class="row" style="margin-left: 5px">
        ...
        <div class="col-sm-1">
            <h4 class="hj1">说说 <?php echo (session('moments')); ?></h4>
            <div class="dliv" style="width:70px;"></div>
        </div>
        <div class="col-sm-1" onclick="location='/write-it-now-win-/Home/User/collection'">
            <h4 class="hj1" style="color: red">收藏 <?php echo (session('collection')); ?></h4>
        ...
        <div class="col-sm-1">
            <h4 class="hj1" onclick="location='/write-it-now-win-/Home/Checking/checkingList'">审核 <?php echo (session('check')); ?></h4>
            <div class="dliv" style="width:70px;"></div>
        </div>
    ...
    <div class="content" style="min-height: 200px">
        <?php if($count == 0): ?><h3>您现在还没有收藏栏目</h3>
        <?php else: ?>
            <?php if(is_array($res)): foreach($res as $key=>$v): ?><div class="row bs" style="margin-bottom: 30px;padding-top: 10px;padding-bottom: 10px" >
                            <div class="col-sm-2" style="margin-left: 50px" onclick="location='/write-it-now-win-/Home/StoryShow/readerStoryShow/s_id/<?php echo ($v["collection"]["id"]); ?>'">
                                <img src="/write-it-now-win-/Public/<?php echo ($v["collection"]["picture"]); ?>" style="width: 150px;height: 180px">
                            </div>
                            <div class="col-sm-8 "  onclick="location='/write-it-now-win-/Home/StoryShow/readerStoryShow/s_id/<?php echo ($v["collection"]["id"]); ?>'">
                                <h4 style="display: inline"><?php echo ($v["collection"]["name"]); ?></h4><span style="border: 1px solid red;margin-left: 5px;color: #8B6914">都市</span>
                                <span style="border: 1px solid red;margin-left: 5px;color: #8B6914">
                                    <?php if($v.collection.is_doing == 0): ?>连载中
                                     <?php else: ?>
                                        完结<?php endif; ?>
                                </span>
                                <br />
                                ...
                                <p style="margin-bottom: 20px; color:#858585;">
                                    简介：<?php echo ($v["collection"]["info"]); ?>
                                </p>
                                <span style="color:#858585;float:left">
                                    <?php echo ($v["collection"]["click_total_count"]); ?>次阅读
                                </span>
                                <span style="color:#858585;margin-left: 30px">共 <?php echo ($v["collection"]["font_count"]); ?> 字</span>
                                <span style="color:#858585;float:right">
                                    <?php echo ($v["collection"]["create_time"]); ?>
                                </span>
                            </div>
