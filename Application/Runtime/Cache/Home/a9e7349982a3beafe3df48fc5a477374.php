...
<style>
    ...
    .follow-info .user-info{
        margin-left: -20px;
    }
    .follow-info .user-info .btn1{
        margin-top: 20px;
        font-size: 12px;
    }
    .showmore{
...
<div class="follow container">
    <div class="menu">
        <span><a href="/write-it-now-win-/Home/Index/showAuthor/author/<?php echo ($author_id); ?>">Ta的主页</a> > <span>关注</span></span>
    </div>
    <div class="menu-tab">
        <span class="menu-tab-follow"><em><b>关注&nbsp; <?php echo ($count); ?></b></em></span>&nbsp;
    ...
    <?php if($count == 0): ?><h3>作者暂时没有关注对象</h3>
    <?php else: ?>
                    ...
                    <?php if(is_array($res)): foreach($res as $key=>$v): ?><div class="col-sm-4" style="padding-bottom: 20px">
                            <div class="row">
                                <div class="col-sm-3 user-head">
                                    <a href="/write-it-now-win-/Home/Index/showAuthor/author/<?php echo ($v["followed"]["id"]); ?>"><img src="/write-it-now-win-/Public/<?php echo ($v["followed"]["picture"]); ?>" class="img-circle" /></a>
                                </div>
                                <div class="col-sm-9 user-info" >
                                    <p class="name"><a href="/write-it-now-win-/Home/Index/showAuthor/author/<?php echo ($v["followed"]["id"]); ?>"><?php echo ($v["followed"]["name"]); ?></a></p>
                                    <p><?php echo ($v["followed"]["per_signature"]); ?></p>
                                </div>
                            </div>
