...
<body style="background-color: #F2F2F2">
    ...
    <div class="container" style="background-color: white;margin-top: 15px;padding-top: 15px;min-height: 600px;margin-bottom: 30px">
        ...
        <div>
            <span style="color:blue;margin-left:5px;margin-right: 20px">栏目 <?php echo (session('story_count')); ?></span> | <a  data-toggle="modal" data-target="#myModal2" style="margin-right: 20px">新建栏目</a> | <span style="margin-left: 20px">共 <?php echo ($font_count); ?> 字</span>
        </div>
            ...
            <?php if($result==0): ?><h3>您暂无栏目，请创建！</h3>
                ...
                <?php if(is_array($result)): foreach($result as $key=>$v): ?><div class="row bs" style="margin-bottom: 30px;padding-top: 10px;padding-bottom: 10px" >
                    ...
                    <div class="col-sm-2" style="margin-left: 50px" onclick="location='/write-it-now-win-/Home/StoryShow/authourStoryShow/s_id/<?php echo ($v["id"]); ?>'">
                        <img src="/write-it-now-win-/Public/<?php echo ($v["picture"]); ?>" style="width: 150px;height: 180px">
                    </div>
                    <div class="col-sm-8 " style="margin-top: -20px" onclick="location='/write-it-now-win-/Home/StoryShow/authourStoryShow/s_id/<?php echo ($v["id"]); ?>'">
                        ...
                        <span style="color:#858585;float:left">
                                <?php echo ($v["click_total_count"]); ?>次阅读
                            </span>
                        <span style="color:#858585;margin-left: 30px">共 <?php echo ($v["font_count"]); ?> 字</span>
