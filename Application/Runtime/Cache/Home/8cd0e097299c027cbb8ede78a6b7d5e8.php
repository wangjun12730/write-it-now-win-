...
<div class="sectionList container">
    ...
    <div class="book-info">
        ...
        <p>
            ...
            <span>最新章节：<a href="/write-it-now-win-/Home/StoryShow/storyInfo/s_id/<?php echo ($story["id"]); ?>/section/<?php echo ($new["id"]); ?>"><?php echo ($new["section"]); ?> &nbsp;<?php echo ($new["title"]); ?></a></span>
            &nbsp;&nbsp;<span>更新时间：<?php echo ($new["create_time"]); ?></span>
        </p>

    </div>
    <div class="section-con">
        <span class="con1"><a href="/write-it-now-win-/Home/StoryShow/storyInfo/s_id/<?php echo ($story["id"]); ?>">[全文阅读]</a></span>
    </div>
    ...
    <div class="section-content">
        ...
        <div class="section" >
            <?php if(is_array($section)): foreach($section as $key=>$v): ?><div class="col-sm-4 col-xs-6 text-center " >
                    <a href="/write-it-now-win-/Home/StoryShow/storyInfo/s_id/<?php echo ($story["id"]); ?>/section/<?php echo ($v["id"]); ?>"><?php echo ($v["section"]); ?> <?php echo ($v["title"]); ?></a>
