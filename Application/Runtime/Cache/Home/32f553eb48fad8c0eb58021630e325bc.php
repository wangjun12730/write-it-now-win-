...
<div class="container" style="background-color: white;margin-top: 15px;padding-top: 15px;margin-bottom: 30px">
    <div class="row" style="margin-left: 5px">
        ...
        <div class="col-sm-1" onclick="location='/write-it-now-win-/Home/Message/messageList'">
            <h4 class="hj1" style="color: red">消息 <?php echo (session('messages')); ?></h4>
            <div class="dliv" style="width:70px;border-bottom: 3px solid red;margin-left: -8px;margin-top: 15px"></div>
        </div>
    </div>
    <hr style="margin-top: 0px" />
    <div>
        <span style="color:blue;margin-left:5px;margin-right: 20px">消息 <?php echo (session('messages')); ?></span>
    </div>
    <br />
    <div class="content" style="min-height: 200px">
        <?php if($empty==1): ?><h1>您现在没有消息</h1>
        <?php else: ?>
            <table class="table table-hover table-striped">
                ...
                <?php if(is_array($result)): foreach($result as $key=>$v): ?><tr>
                        ...
                        <td><?php echo ($v["send_man"]); ?></td>
                        <td><?php echo ($v["create_time"]); ?></td>
                        <td><a class="btn btn-danger" href="/write-it-now-win-/Home/Message/deleteMessage/m_id/<?php echo ($v["id"]); ?>">删除</a></td>
