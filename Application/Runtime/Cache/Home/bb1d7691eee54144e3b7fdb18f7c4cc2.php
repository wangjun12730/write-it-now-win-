...
<div class="container" style="background-color: white;margin-top: 15px;padding-top: 15px;margin-bottom: 30px">
    <div class="row" style="margin-left: 5px">
        ...
        <div class="col-sm-1" onclick="location='/write-it-now-win-/Home/User/follow'">
            <h4 class="hj1" style="color: red">关注 <?php echo (session('follow')); ?></h4>
    ...
    <div class="content" style="min-height: 200px">
        <?php if($count == 0): ?><h3>您目前还没有关注</h3>
        <?php else: ?>
            <div class="row">
                <?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="col-sm-4" style="padding-bottom: 20px">
                            <div class="row">
                                <div class="col-sm-3 user-head">
                                    <a href="/write-it-now-win-/Home/Index/showAuthor/author/<?php echo ($v["id"]); ?>"><img src="/write-it-now-win-/Public/<?php echo ($v["picture"]); ?>" class="img-circle" style="width: 60px;height: 60px"/></a>
                                </div>
                                <div class="col-sm-9 user-info" >
                                    <p class="name"><a href="/write-it-now-win-/Home/Index/showAuthor/author/<?php echo ($v["id"]); ?>" style="font-size: 18px;color: black"><?php echo ($v["name"]); ?></a></p>
                                    <p style="margin-left: 20px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis"><?php echo ($v["per_signature"]); ?></p>
                                </div>
                            </div>
