...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <form class="form-horizontal" method="post"  action="/write-it-now-win-/Home/StoryShow/uploadSection">
            <div class="modal-content">
                <div class="modal-header" style="background:#6495ED">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h5 class="modal-title" id="myModalLabel4">新建栏目</h5>
                </div>
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="col-sm-11 col-xs-12">
                            <div class="form-group">
                                <label for="section" class="col-sm-3 control-label">章节</label>
                                <div class="col-sm-9">
                                    <input type="text" id="section" class="form-control" name="section" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="is_doing" class="col-sm-3 control-label">是否完结</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label for="title" class="col-sm-3 control-label">章节主题</label>
                                <div class="col-sm-9">
                ...
                <div class="modal-footer" style="background:#B0E0E6;margin-bottom:-30px;">
                    <input type="hidden" name="user_name" value="<?php echo ($story["user_name"]); ?>" />
                    <input type="hidden" name="user_id" value="<?php echo ($story["user_id"]); ?>" />
...
<div class="container" style="background-color: white;margin-top: 15px;padding-top: 15px;margin-bottom: 30px">
    <button class="btn btn-warning">新建章节</button>
    <button class="btn btn-primary" id="shangchuan" data-toggle="modal" data-target="#myModal3">上传</button>
    <section id="editor" >
        <div id='edit' style="margin-top: 30px;">
            <h1>请输入章节内容</h1>

            <h3 style="margin-top: 60px;padding-bottom: 20px;">输入完毕后，点击上传，填写表单，完成提交。。。</h3>
        </div>
    </section>
</div>
