...
!function (a) {
    ...
    a.Editable.prototype.refreshColors = function () {
        ...
        this.refreshColor(a, "background-color", "backColor"),
        this.refreshColor(a, "color", "foreColor")
    },
    ...
    a.Editable.commands = a.extend(a.Editable.commands, {
        color: {
            ...
            callbackWithoutSelection: function (b, c, d) {
                "backColor" === d && (d = "background-color"),
                "foreColor" === d && (d = "color"),
                this._startInFontExec(d, b, c),
                "#123456" === c && "" === this.text() && (this.cleanify(!0, !1), this.$element.find("span").each(function (b, c) {
                        var d = a(c),
    ...
    a.Editable.prototype.buildDropdownColor = function (a) {
        for (var b = '<div class="fr-dropdown-menu">', c = 0; c < a.seed.length; c++) {
            for (var d = a.seed[c], e = '<div><p><span data-text="true">' + d.title + '</span> <a data-val="#123456" data-cmd="color" data-param="' + d.cmd + '" class="fr-bttn" title="Clear"><i class="fa fa-eraser"></i></a></p>', f = 0; f < d.value.length; f++) {
                var g = d.value[f];
                e += '<button type="button" class="fr-color-bttn" data-val="' + g + '" data-cmd="color" data-param="' + d.cmd + '" style="background-color: ' + g + ';">&nbsp;</button>',
                f % 8 == 7 && f > 0 && (e += "<hr/>", (7 == f || 15 == f) && (e += '<div class="separator"></div>'))
            }
            e += "</div>",
            b += e
        }
    ...
    a.Editable.prototype.backColor = function (b) {
        this.inlineStyle("background-color", "backColor", b),
    ...
    a.Editable.prototype.foreColor = function (b) {
        this.inlineStyle("color", "foreColor", b),
        this.$element.find("span").each(function (b, c) {
            var d = a(c),
            e = d.css("color");
            ("#123456" === e || "#123456" === a.Editable.RGBToHex(e)) && d.css("color", "")
